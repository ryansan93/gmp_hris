...
class UsulanMutasi extends Public_Controller {

    private $pathView = 'hris/usulan_mutasi/';
    private $url;
    private $hakAkses;
    ...
    public function index($segment=0)
    {
        ...
        if ( $this->hakAkses['a_view'] == 1 ) {
            ...
            $this->add_external_js(array(
                ...
                "assets/hris/usulan_mutasi/js/usulan_mutasi.js",
            ));
            $this->add_external_css(array(
                ...
                "assets/hris/usulan_mutasi/css/usulan_mutasi.css",
            ));
            ...
            $content['title_panel']     = 'HRIS - Usulan Mutasi';
            ...
            // Load Indexx
            $data['title_menu']     = 'HRIS - Usulan Mutasi';
    ...
    public function save()
    {
        ...
        try {
            ...
            $m_db->atasan_mutasi        = $params['atasan_baru'];
    ...
    public function generate_kode()
    {
		...
		WHERE kode  LIKE 'DOC/MTS/{$tahun}{$bulan}%'";
